...
export const WellboreDiagram: React.FC<WellboreDiagramProps> = ({
  ...
  // Calculate depth scale (ensure we don't divide by zero)
  const depthScale =
  ...
  return (
    <div className={`wellbore-diagram ${className} flex flex-col gap-4`}>
      {/* Wellbore Schematic with Legend - Side by Side */}
        ...
        <div className="flex-shrink-0">
          ...
          >
            ...
            {sortedCasing.map((casing, idx) => {
              ...
              return (
                <g key={idx}>
                  ...
                  {/* Casing size label (industry standard format) */}
                  {casing.size !== null && (
                    <text
            ...
            {(data.perforation_intervals || []).map((perf, idx) => {
              ...
              const isSqueezed = status === "squeezed" || status === "closed";
              ...
              return (
                <g key={idx}>
                  ...
                  <title>
                    ...
                    {perf.formation ? ` - Formation: ${perf.formation}` : ""}
              ...
              return (
                <g key={idx}>
                  ...
                  {isPacker && (
                    <g>
                      <path
                        ...
                        } ${toolY} L ${wellCenterX} ${toolY + toolSize / 2} L ${
                          wellCenterX + toolSize / 2
                        } ${toolY} Z`}
                        fill="#4169e1"
                        stroke="#333"
                  ...
                  <title>
                    ...
                    {tool.depth !== null ? ` - Depth: ${tool.depth}ft MD` : ""}
      ...
      {/* Summary Tables Panel - Below diagram and legend */}
      <div className="w-full">
        <WellboreSummaryTables data={data} size={size} />
      </div>
    </div>
  );
};
